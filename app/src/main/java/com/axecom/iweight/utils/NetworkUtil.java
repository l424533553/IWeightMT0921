package com.axecom.iweight.utils;
...
public class NetworkUtil {
    ...
    public static boolean isMobileEnabled(Context context) {
        try {
            @SuppressLint("PrivateApi") Method e = ConnectivityManager.class.getDeclaredMethod("getMobileDataEnabled", new Class[0]);
            e.setAccessible(true);
            return (Boolean) e.invoke(getConnManager(context), new Object[0]);
